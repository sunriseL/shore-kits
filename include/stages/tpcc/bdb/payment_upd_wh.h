...
class payment_upd_wh_packet_t : public bdb_trx_packet_t {
...
public:
    ...
    /**
     *  @brief payment_upd_wh_packet_t constructor.
     *
    ...
    payment_upd_wh_packet_t(const c_str    &packet_id,
...
}; // END OF CLASS: payment_upd_wh_packet_t



/**
 *  @brief PAYMENT_UPD_WH stage. 
 *
...
public:
    ...
    typedef payment_upd_wh_packet_t stage_packet_t;

    payment_upd_wh_stage_t();
    
    virtual ~payment_upd_wh_stage_t() { 

	TRACE(TRACE_ALWAYS, "PAYMENT_UPD_WH destructor\n");
    }
    
}; // END OF CLASS: payment_upd_wh_stage_t
