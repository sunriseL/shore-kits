 ...
 *
 *  @brief Implementation of the TPC-C table parsing functions for BDB
 *
...
void tpcc_parse_tbl_STOCK     (Db* db, FILE* fd) { 
    ...
    while (fgets(linebuffer, MAX_LINE_LENGTH, fd)) {
        ...
        tup.S_YTD = atoi(tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[0],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[1],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[2],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[3],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[4],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[5],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[6],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[7],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[8],tmp);
        tmp = strtok(NULL, "|");
        store_string(tup.S_DIST[9],tmp);
        tmp = strtok(NULL, "|");
